...
public protocol ComponentWithDelegate: Component {
     ...
     * - WARNING: When listening to Component's actions, subscribe to **action** instead of this variable. **action** includes **perform(action:)** calls as well as `Observable`s defined in **actions**.
     */
