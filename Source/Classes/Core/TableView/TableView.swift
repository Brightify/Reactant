...
open class TableView<HEADER: UIView, CELL: UIView, FOOTER: UIView>: ViewBase<TableViewState<SectionModel<(header: HEADER.StateType, footer: FOOTER.StateType), CELL.StateType>>>, UITableViewDelegate where HEADER: Component, CELL: Component, FOOTER: Component {
